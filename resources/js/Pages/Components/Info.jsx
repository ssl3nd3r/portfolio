    ...
    <div className='lg:fixed lg:h-screen flex flex-col gap-8 justify-between p-8 lg:px-20 lg:py-14 lg:max-w-[55vw] xl:max-w-[45vw]'>
        ...
        <div className='flex flex-col gap-2'>
          ...
          <div className='flex items-center flex-wrap gap-4'>
            ...
            onMouseEnter={displaySkill()} onMouseLeave={() => setSkill(false)} alt="Laravel" /> 
            <img loading='lazy' src="/storage/html.png" className='h-10 cursor-pointer hover:scale-105 transition-all'
            onMouseEnter={displaySkill()} onMouseLeave={() => setSkill(false)} alt="HTML" /> 
            <img loading='lazy' src="/storage/css.png" className='h-10 cursor-pointer hover:scale-105 transition-all'
            onMouseEnter={displaySkill()} onMouseLeave={() => setSkill(false)} alt="CSS" />
            <img loading='lazy' src="/storage/tailwind.png" className='h-10 cursor-pointer hover:scale-105 transition-all'
            onMouseEnter={displaySkill()} onMouseLeave={() => setSkill(false)} alt="TailwindCSS" /> 
          </div>
        ...
        <div className='flex flex-col gap-3'>
          ...
          <span className='text-sm'>Inspired by <a className='quick-link' href="https://www.sarahdayan.dev/">Sarah Dayan</a> and <a className='quick-link' href="https://dribbble.com/NicolasMzrd">Nicolas Meuzard</a></span>
        </div>
    </div>
  )
}
